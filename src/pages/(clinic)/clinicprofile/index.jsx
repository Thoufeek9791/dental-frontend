...
const PatientsProfile = () => {
  return (
    <div>
      <>
        <Header />
        <Sidebar id="menu-item2" id1="menu-items2" activeClassName="clinic" />
        <>
                        ...
                        <div className="card">
                          <div className="card-body">
                            <div className="heading-detail ">
                              ...
                              <p>
                                Hello I am Smith Bruklin a Gynaecologist in Sanjivni Hospital Surat.
                                I love to work with all my hospital staff and seniour doctors.
                              </p>
                            </div>
                        ...
                        <div className="card">
                          <div className="card-body">
                            <div className="tab-content-set">
                              <ul className="nav">
                                <li>
                                  <Link to="/patientsprofile" className="active">
