...
const DoctorDashboard = () => {
  ...
  return (
    <>
      <Header />
      <Sidebar id="menu-item" id1="menu-items" activeClassName="doctor-dashboard" />
      <>
                    ...
                    <div className="chart-title patient-visit">
                      ...
                      <div>
                        <ul className="nav chat-user-total">
                          <li>
                            <i className="fa fa-circle low-users" aria-hidden="true" />
                            Low
                          </li>
                          <li>
                            <i className="fa fa-circle current-users" aria-hidden="true" /> Highh
                          </li>
                        </ul>
                      </div>
                      <div className="form-group mb-0">
                              ...
                              <li className=" dropdown ongoing-blk ">
                                ...
                                <ul className="doctor-sub-list dropdown-menu">
                                  <li className="patient-new-list dropdown-item">
                                    ...
                                    <Link to="#" className="new-dot status-green">
