                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div id="donut-chart-dash" className="chart-user-icon">
                      ...
                      <Chart options={patientDepartment} />
                      <img src={user001} alt="#" />
                    </div>
                  </div>
                </div>
                      ...
                      <table className="table mb-0 border-0 datatable custom-table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <button className="custom-badge status-green ">Fracture</button>
                            </td>
                            <td className="text-end">
                              <div className="dropdown dropdown-action">
                                ...
                                <div className="dropdown-menu dropdown-menu-end">
                                  <Link className="dropdown-item" to="/appoinmentlist">
                          ...
                          <tr>
                            ...
                            <td>
                              <button className="custom-badge status-green">Fever</button>
                            </td>
                            <td className="text-end">
                              <div className="dropdown dropdown-action">
                                <Link
              ...
              <div className="col-12 col-xl-12">
                <div className="card">
                  <div className="card-header pb-0">
                    ...
                    <Link to="/editpatients" className="float-end patient-views">
                      Show all
                    </Link>
                  </div>
                      ...
                      <table className="table mb-0 border-0 datatable custom-table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>Heart attack</td>
                            <td>
                              <button className="custom-badge status-green ">Non Urgent</button>
                            </td>
                            <td className="text-end">
                              <div className="dropdown dropdown-action">
                                <Link
                          ...
                          <tr>
                            ...
                            <td>Jaundice</td>
                            <td>
                              <button className="custom-badge status-pink">Emergency</button>
                            </td>
                            <td className="text-end">
                              <div className="dropdown dropdown-action">
                                <Link
                          ...
                          <tr>
                            ...
                            <td>Malaria</td>
                            <td>
                              <button className="custom-badge status-gray">Out Patient</button>
                            </td>
                            <td className="text-end">
                              <div className="dropdown dropdown-action">
                                <Link
                          ...
                          <tr>
                            ...
                            <td>Typhoid</td>
                            <td>
                              <button className="custom-badge status-orange">Non Urgent</button>
                            </td>
                            <td className="text-end">
                              <div className="dropdown dropdown-action">
                                <Link
