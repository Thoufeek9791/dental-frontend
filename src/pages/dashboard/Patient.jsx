...
const PatientDashboard = () => {
  ...
  return (
    <>
      <Header />
      <Sidebar id="menu-item" id1="menu-items" activeClassName="patient-dashboard" />
      <>
                ...
                <div className="card report-blk">
                  <div className="card-body">
                    <div className="report-head">
                      <h4>
                        <img src={report_icon1} className="me-2" alt="#" />
                        Heart Rate
                      </h4>
                    </div>
                    <div id="heart-rate" />
                    {/* <HeartRateChart /> */}
                    <Chart options={heartRate} />
              ...
              <div className="col-12 col-md-6 col-xl-3 d-flex">
                <div className="card report-blk">
                  <div className="card-body">
                    <div className="report-head">
                      <h4>
                        <img src={report_icon2} className="me-2" alt="#" />
                        Temperature
                      </h4>
                    </div>
                    <div id="temperature-chart" />
                    <Chart options={temperature} />
                    <div className="dash-content">
                      <h5>
                        38.6 <span>c</span>
                      </h5>
              ...
              <div className="col-12 col-md-6 col-xl-3 d-flex">
                <div className="card report-blk">
                  <div className="card-body">
                    <div className="report-head">
                      <h4>
                        <img src={report_icon3} className="me-2" alt="#" />
                        Blood Pressure
                      </h4>
                    </div>
                    <div id="pressure-chart" />
                    {/* <PressureChart /> */}
                    <Chart options={pressure} />
                    <div className="dash-content">
                      <h5>
                        120 <span>mm/Hg</span>
                      </h5>
              ...
              <div className="col-12 col-md-6 col-xl-3 d-flex">
                <div className="card report-blk">
                  <div className="card-body">
                    <div className="report-head">
                      <h4>
                        <img src={report_icon4} className="me-2" alt="#" />
                        Sleep
                      </h4>
                    </div>
                    <div id="sleep-chart" />
                ...
                <div className="treat-box mb-2">
                  <div className="user-imgs-blk">
                    <div className="circle-bar circle-bar2">
                      <div className="circle-graph2" data-percent="66">
                        {/* <div>
                          <Calendar style={{ widht: '100%' }} onChange={onChange} value={value} />
                        </div> */}
                        <div style={{ width: '100%' }}>
